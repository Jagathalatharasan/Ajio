...
<body>
	...
	<center>
		...
		<br> <br> <br> <br> <a href="checkout.jsp"
			class="btn btn-success">Place Order</a> <br> <br> <br>
		<br> <a href="loginhome.jsp" class="btn btn-success">Continue
			Shopping</a>
	</center>
	<br>
	<br>
